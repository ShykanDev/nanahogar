...
<section>
  ...
  <section class="grid grid-cols-2 gap-4 p-4 font-bold md:grid-cols-3 lg:grid-cols-4 font-poppins bg-gradient-to-r from-orange-700 via-yellow-500 to-orange-700">
    ...
    <div class="relative overflow-hidden bg-white rounded-lg shadow-lg">
      <img src="https://storage.googleapis.com/a1aa/image/vQmvgmEt6xYaNlMXBy1zhLE6sRf9eAq4V7JbfkU7RGfobeveE.jpg" alt="Conflicto de pareja" class="object-cover w-full h-full">
      <h2 class="absolute bottom-0 left-0 right-0 p-4 text-center text-white bg-black bg-opacity-50">Solución al dolor de rodilla</h2>
    </div>

    <div class="relative overflow-hidden bg-white rounded-lg shadow-lg">
      <img src="https://storage.googleapis.com/a1aa/image/y0VncefBlokgF0K6HgxRkE5ftyBNabmmdHGf77RDSCYvgeveE.jpg" alt="Dificultades sexuales" class="object-cover w-full h-full">
      <h2 class="absolute bottom-0 left-0 right-0 p-4 text-center text-white bg-black bg-opacity-50">Alivio al dolor articular de manos</h2>
    </div>

    <div class="relative overflow-hidden bg-white rounded-lg shadow-lg">
      <img src="https://storage.googleapis.com/a1aa/image/x17JIXDx614KDFmnX8sG5GLhJWvCTpGyk1adOJ6eSd8M0f1TA.jpg" alt="Tensión en la relación" class="object-cover w-full h-full">
      <h2 class="absolute bottom-0 left-0 right-0 p-4 text-center text-white bg-black bg-opacity-50">Solución al dolor muscular de cuello</h2>
    </div>
  </section>
</section>
